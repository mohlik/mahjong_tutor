var PurchaseFailed = new Phaser.Class({
 
	Extends: Phaser.GameObjects.Container,   

	initialize:

	function PurchaseFailed (scene)
    {
	...
	init(params) {  
		...
		res = game_data['utils'].generate_string({'scene_id': 'game_windows', 'item_id': 'purchase_failed', 'phrase_id': '1', 'values': [], 'base_size': 32});		
		...
		temp = new Phaser.GameObjects.Image(this.scene, 0, 0, 'common2', 'ico_uncomplete');
		this.add(temp);

		res = game_data['utils'].generate_string({'scene_id': 'game_windows', 'item_id': 'purchase_failed', 'phrase_id': '2', 'values': [], 'base_size': 32});		
		...
		res = game_data['utils'].generate_string({'scene_id': 'game_windows', 'item_id': 'purchase_failed', 'phrase_id': '3', 'values': [], 'base_size': 30});		
